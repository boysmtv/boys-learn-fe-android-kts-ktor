...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
     ...
     */
    public AppcenterLibraryAccessors getAppcenter() { return laccForAppcenterLibraryAccessors; }
    ...
    public static class AppcenterLibraryAccessors extends SubDependencyFactory {
        ...
        public AppcenterLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getAnalytics() { return create("appcenter.analytics"); }

            /**
             * Creates a dependency provider for crashes (com.microsoft.appcenter:appcenter-crashes)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getCrashes() { return create("appcenter.crashes"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: appcenterAnalytics (5.0.4)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getAppcenterAnalytics() { return getVersion("appcenterAnalytics"); }

            /**
             * Returns the version associated to this alias: appcenterCrashes (5.0.4)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getAppcenterCrashes() { return getVersion("appcenterCrashes"); }
