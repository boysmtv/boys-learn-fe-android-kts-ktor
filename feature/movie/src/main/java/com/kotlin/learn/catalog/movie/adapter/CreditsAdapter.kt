...
import coil.load
import com.kotlin.learn.catalog.core.model.CastModel
import com.kotlin.learn.catalog.core.model.CrewModel
import com.kotlin.learn.catalog.core.utilities.Constant
import com.kotlin.learn.catalog.feature.movie.R
import com.kotlin.learn.catalog.feature.movie.databinding.MovieCreditsItemBinding
...
sealed class CreditsAdapter {
    ...
    class Cast :
        ...
        override fun onBindViewHolder(holder: Cast.ViewHolder, position: Int) {
            val item = getItem(position)
            item?.let { holder.bind(it) }
        }

        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Cast.ViewHolder {
            return ViewHolder(
    ...
    class Crew :
        ...
        override fun onBindViewHolder(holder: Crew.ViewHolder, position: Int) {
            val item = getItem(position)
            item?.let { holder.bind(it) }
        }

        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Crew.ViewHolder {
            return ViewHolder(
                MovieCreditsItemBinding.inflate(
                    LayoutInflater.from(parent.context), parent, false
                )
